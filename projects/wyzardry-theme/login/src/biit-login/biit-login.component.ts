...
import {Type} from 'wyzardry-theme/inputs';
import {BiitLogin} from "wyzardry-theme/models";
...
@Component({
  ...
  providers: [{
    ...
    useValue: {scope: 'wyzardry-theme/login', alias: "login"},
    multi: true
  }, {
    provide: TRANSLOCO_SCOPE,
    useValue: {scope: 'wyzardry-theme/login-welcome', alias: "login-welcome"},
    multi: true
  }]
})
