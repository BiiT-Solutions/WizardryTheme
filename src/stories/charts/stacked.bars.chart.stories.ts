...
} from "../../../projects/biit-ui/charts/src/stacked-bars-chart/stacked-bars-chart.module";
import {
  StackedBarsChartComponent
} from "../../../projects/biit-ui/charts/src/stacked-bars-chart/stacked-bars-chart.component";

export default {
  title: 'Charts/Stacked Bars',
  decorators: [
    moduleMetadata({
      imports: [StackedBarsChartModule],
    }),
  ],
  args: {
    width: 500,
...
const Template: Story<StackedBarsChartComponent> = (args: StackedBarsChartComponent) => ({
  props: args,
  template: `
